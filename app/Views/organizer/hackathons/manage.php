                ...
                >
                    ...
                    <div class="card-body p-4">
                        ...
                        <div
                            class="progress"
                            role="progressbar"
                            aria-valuenow="<?= (int) $participantPercent ?>"
                            aria-valuemin="0"
                            aria-valuemax="100"
                        >
                            ...
                            <div
                                class="progress-bar"
                                style="width: <?= (float) $participantPercent ?>%;"
                            ></div>
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6 col-xl-4">
                    ...
                    >
                        ...
                        <a
                            href="/TECHATHON/public/organizer/hackathons/<?= (int) $hackathon['id'] ?>/registrations"
